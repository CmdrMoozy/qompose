...
// clang-format off
const QString
        TEST_DOCUMENT_CONTENTS_TABS(
                "/*!\n"
                " * This function performs the first step of "
                "decreaseSelectionIndent. Namely,\n"
                " * we try to remove at most one full indentation string from "
                "the beginning of\n"
                " * each block in the selection, and we return true if at "
                "least one block was\n"
                ...
                " * \\return True if at least one block was successfully "
                "de-indented.\n"
                " */\n"
                "bool deindentSelection(\n"
                "        QTextCursor &cursor,\n"
                "        qompose::editor::algorithm::CursorSelectionState "
                "const &state,\n"
                ...
                "	QString indentStr =\n"
                "	        "
                "qompose::editor::algorithm::getIndentationString(mode, "
                "width);\n\n"
                "	qompose::editor::algorithm::foreachBlock(\n"
                "	        cursor, state.startPosition, "
                "state.blockCount,\n"
                "	        [width, &indentStr, &foundIndent](QTextCursor "
                "&c)\n"
                "	        {\n"
                "		        // If this block starts with our "
                "indentation string, we\n"
                "		        // want to remove that one instance of "
                "it from the\n"
                "		        // block.\n"
                "		        "
