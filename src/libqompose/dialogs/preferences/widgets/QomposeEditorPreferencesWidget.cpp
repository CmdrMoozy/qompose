...
QomposeEditorPreferencesWidget::QomposeEditorPreferencesWidget(
	...
	: QomposePreferencesWidget(s, p, f), layout(nullptr),
		...
		lineWrapGuideColorButton(nullptr), colorsGroupBox(nullptr),
		colorsLayout(nullptr), editorFGLabel(nullptr),
		editorFGButton(nullptr), editorBGLabel(nullptr),
		editorBGButton(nullptr), currentLineBGLabel(nullptr),
		currentLineBGButton(nullptr), gutterFGLabel(nullptr),
		gutterFGButton(nullptr), gutterBGLabel(nullptr),
...
void QomposeEditorPreferencesWidget::initializeGUI()
{
	...
	lineWrapGuideColorLabel = new QLabel(tr("Color"),
		lineWrapGuideGroupBox, nullptr);
	...
	lineWrapGuideLayout->addWidget(
		lineWrapGuideWidthLabel, 1, 0, 1, 1, nullptr);
	lineWrapGuideLayout->addWidget(
		lineWrapGuideWidthSpinBox, 1, 1, 1, 1, nullptr);
	lineWrapGuideLayout->addWidget(
		lineWrapGuideColorLabel, 2, 0, 1, 1, nullptr);
	lineWrapGuideLayout->addWidget(
		lineWrapGuideColorButton, 2, 1, 1, 1, nullptr);
